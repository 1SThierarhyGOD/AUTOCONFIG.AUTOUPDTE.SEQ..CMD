...
namespace ExampleWebApi.Controllers
{
    ...
    public class SamlController : Controller
    {
        ...
        public async Task<IActionResult> InitiateSingleLogout(string returnUrl)
        {
            ...
            var cookieName = _configuration["JWT:CookieName"] ?? throw new Exception("A JWT cookie name must be configured");

            Response.Cookies.Delete(cookieName, _cookieOptions);
        ...
        public async Task<IActionResult> AssertionConsumerService()
        {
            ...
            Response.Cookies.Append(cookieName, jwt, _cookieOptions);
        ...
        private JwtSecurityToken CreateJwtSecurityToken(ISpSsoResult ssoResult)
        {
            ...
            var jwtKey = _configuration["JWT:Key"] ?? throw new Exception("A JWT key must be configured.");
